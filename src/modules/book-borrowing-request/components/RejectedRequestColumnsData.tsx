...
export const RejectedRequestColumnsData: ColumnDef<BorrowingRequest>[] = [
    {
        accessorKey: 'id',
        header: ({ column }) => (
            <DataTableColumnHeader className="w-20" column={column} title='Request' />
        ),
    ...
    },
    {
        ...
        header: ({ column }) => (
            <DataTableColumnHeader className="w-[60px]" column={column} title='Requestor' />
        ),
    ...
    },
    {
        ...
        header: ({ column }) => (
            <DataTableColumnHeader className="w-20" column={column} title='Refusor' />
        ),
    ...
    },
    {
        ...
        header: ({ column }) => (
            <DataTableColumnHeader className="w-20" column={column} title='Rejected Date' />
        ),
