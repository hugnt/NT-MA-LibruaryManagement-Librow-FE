...
import { BookCategory } from "@/types/BookCategory.type";
import { FormMode, FormSetting, formSettingDefault } from "@/types/common";
...
interface FormDetailProps {
  ...
  data?: BookCategory,
  title?: string,
  onSubmit?: (data: BookCategory) => void
}

export default function FormDetail(props: FormDetailProps) {
  let { formSetting = formSettingDefault, setFormSetting = () => { }, data, onSubmit = () => { }, title = "Details" } = props;
