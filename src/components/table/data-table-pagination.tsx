...
export default function DataTablePagination(props: DataTablePaginationProps) {
  let { isDisplaySelectedRows = false, selectedRows = 0, pageSizeList = [10, 20, 30, 40, 50], pageSize = 10, onPageSizeChanged=()=>{} , pageNumber = 1, onPageNumberChanged=()=>{}, totalRecords = 0 } = props;
